...
echo "============================================="
echo ""
echo "🚀 NEW: Simplified Fast Workflow (Recommended)"
echo "  1. /pm:task-explore \"<task>\"  - Deep code exploration"
echo "  2. /pm:task-plan <task-id>     - Create execution plan"
echo "  3. /pm:task-create <task-id>   - Create GitHub issue"
echo "  4. /pm:task-execute <issue#>   - Execute with parallel agents"
echo ""
echo "  ⚡ 85% faster than classic workflow!"
echo "  ⚡ Single GitHub issue (not epic + subtasks)"
echo "  ⚡ Perfect for quick iterations"
echo ""
echo "---"
echo ""
echo "🔧 Classic Workflow (Legacy - For Complex Epics)"
...
echo ""
echo "📋 Task Commands (Simplified Workflow)"
...
echo ""
echo "📄 PRD Commands (Classic Workflow)"
...
echo ""
echo "💡 Tips"
echo "  • NEW: Use simplified workflow for most tasks (85% faster!)"
echo "  • Fast workflow: task-explore → task-plan → task-create → task-execute"
echo "  • Classic workflow: prd-new → prd-parse → epic-decompose → epic-sync"
echo "  • Use /pm:next to find available work"
echo "  • Run /pm:status for quick overview"
echo "  • View .claude/tasks/README.md for new workflow docs"
